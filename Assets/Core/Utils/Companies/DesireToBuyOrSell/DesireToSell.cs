namespace Assets.Core
{
    public static partial class Companies
    {
        ...
        public static long GetBaseDesireToSellShares(GameContext gameContext, int companyId, int shareholderId) => GetBaseDesireToSellShares(gameContext, Get(gameContext, companyId), shareholderId, GetInvestorById(gameContext, shareholderId));
