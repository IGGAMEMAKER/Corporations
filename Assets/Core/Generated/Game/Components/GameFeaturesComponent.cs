...
public partial class GameEntity {
    ...
    public void AddFeatures(System.Collections.Generic.Dictionary<ProductFeature, int> newFeatures, int newCount) {
    ...
    public void ReplaceFeatures(System.Collections.Generic.Dictionary<ProductFeature, int> newFeatures, int newCount) {
        var index = GameComponentsLookup.Features;
        var component = (FeaturesComponent)CreateComponent(index, typeof(FeaturesComponent));
        component.features = newFeatures;
        component.Count = newCount;
