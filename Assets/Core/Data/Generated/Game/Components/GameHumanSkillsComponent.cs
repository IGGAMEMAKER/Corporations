...
public partial class GameEntity {
    ...
    public void AddHumanSkills(System.Collections.Generic.Dictionary<WorkerRole, int> newRoles, System.Collections.Generic.List<Trait> newTraits, System.Collections.Generic.Dictionary<NicheType, int> newExpertise) {
    ...
    public void ReplaceHumanSkills(System.Collections.Generic.Dictionary<WorkerRole, int> newRoles, System.Collections.Generic.List<Trait> newTraits, System.Collections.Generic.Dictionary<NicheType, int> newExpertise) {
        var index = GameComponentsLookup.HumanSkills;
        var component = (HumanSkillsComponent)CreateComponent(index, typeof(HumanSkillsComponent));
        component.Roles = newRoles;
        component.Traits = newTraits;
