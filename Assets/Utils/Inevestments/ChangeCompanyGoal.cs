namespace Assets.Utils
{
    public static partial class Investments
    {
        ...
        internal static void SetCompanyGoal(GameContext gameContext, GameEntity company, InvestorGoal investorGoal)
        {
            ...
            switch (investorGoal)
            {
                ...
                case InvestorGoal.GrowCompanyCost:
                    measurableGoal = EconomyUtils.GetCompanyCost(gameContext, company.company.Id) * (100 + Constants.INVESTMENT_GOAL_GROWTH_REQUIREMENT_COMPANY_COST) / 100;
                    break;
            }
        ...
        {
            return nextGoal == InvestorGoal.GrowCompanyCost && EconomyUtils.GetCompanyCost(gameContext, company.company.Id) > Constants.IPO_REQUIREMENTS_COMPANY_COST / 2;
        }
