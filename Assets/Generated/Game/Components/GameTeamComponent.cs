...
public partial class GameEntity {
    ...
    public void AddTeam(int newProgrammers, int newManagers, int newMarketers, int newMorale) {
    ...
    public void ReplaceTeam(int newProgrammers, int newManagers, int newMarketers, int newMorale) {
        var index = GameComponentsLookup.Team;
        var component = (TeamComponent)CreateComponent(index, typeof(TeamComponent));
        component.Programmers = newProgrammers;
        component.Managers = newManagers;
