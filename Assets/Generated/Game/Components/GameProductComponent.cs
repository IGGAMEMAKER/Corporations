...
public partial class GameEntity {
    ...
    public void AddProduct(int newId, string newName, NicheType newNiche, IndustryType newIndustry, int newProductLevel, int newExplorationLevel, Assets.Classes.TeamResource newResources) {
    ...
    public void ReplaceProduct(int newId, string newName, NicheType newNiche, IndustryType newIndustry, int newProductLevel, int newExplorationLevel, Assets.Classes.TeamResource newResources) {
        var index = GameComponentsLookup.Product;
        var component = (ProductComponent)CreateComponent(index, typeof(ProductComponent));
        component.Id = newId;
        component.Name = newName;
